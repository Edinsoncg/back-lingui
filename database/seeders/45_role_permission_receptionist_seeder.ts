...
export default class ReceptionistPermissionSeeder extends BaseSeeder {
  public async run() {
    const receptionistRole = await Role.findByOrFail('name', 'Recepcionista')
    ...
    const allowedPermissionsPerItem: Record<string, string[]> = {
      ...
      'Mi Perfil': ['view', 'edit'],
      'Reporte Estudiantes': ['view'],
      'Reporte Salones': ['view'],
      'Reporte Profesores': ['view'],
      'Usuarios': ['view'],
      'Soporte': ['view'],
    }
